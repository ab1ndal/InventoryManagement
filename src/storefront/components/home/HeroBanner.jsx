  ...
  return (
    <section className="relative min-h-[88dvh] flex items-center justify-center overflow-hidden bg-storefront-charcoal">
      ...
      <div className="relative z-10 text-center px-4 sm:px-8 max-w-4xl mx-auto">
        ...
        {/* Main heading */}
        <h1 className="font-display font-semibold text-storefront-cream leading-none mb-2">
        ...
        {/* Subtext */}
        <p className="font-sans text-sm sm:text-base text-storefront-cream/60 max-w-lg mx-auto mt-6 leading-relaxed tracking-wide">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
          <Link
            to="/shop"
            className="group inline-flex items-center gap-2 bg-storefront-gold hover:bg-storefront-gold-dark text-white font-sans text-sm font-medium tracking-widest uppercase px-8 py-3.5 transition-colors duration-200"
          >
            Explore Collection
            <ArrowRight
              size={15}
          ...
          <Link
            to="/shop"
            className="inline-flex items-center gap-2 border border-storefront-cream/40 hover:border-storefront-cream text-storefront-cream font-sans text-sm font-medium tracking-widest uppercase px-8 py-3.5 transition-colors duration-200"
          >
            New Arrivals
          </Link>
        </div>
        ...
        {/* Trust mini-bar */}
        <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 mt-12 text-[11px] text-storefront-cream/65 tracking-widest uppercase font-sans">
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-1.5 animate-bounce">
        <span className="font-sans text-[9px] tracking-[0.3em] uppercase text-storefront-cream/40">Scroll</span>
